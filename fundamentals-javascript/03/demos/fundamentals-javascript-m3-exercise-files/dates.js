...
let date1 = new Date("2024-04-17");
console.log(date1);
 let date2 = new Date("April 17, 2024");
 console.log(date2); 
 let date3 = new Date();
 console.log(date3);
 let date4 = new Date(2024, 3, 17, 10, 30, 6);
 console.log(date4);

// Accessign elements from a date 

 console.log(`Full year: ${date3.getFullYear()}`);
 console.log(`Month (zero-indexed): ${date3.getMonth}`);
 console.log(`Day of month: ${date4.getDate()}`);
